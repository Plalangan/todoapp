<template>
  <section class="container debug-grid-16-solid">
    <header>
      ...
      <input v-model="currentTodo" @keydown.enter="addTodo()" placeholder="Add todo item here..." />
    </header>
    <section>
      <ul class="todos">
        <li
    ...
    <footer>
      ...
      <div class="static">
        ...
        <div @click="visibility = 'active'" :class="{'items-active': true, selected: visibility === 'active'}">To-Be-Completed</div>
